...
function SpecificRE() {
  ...
  const fetchRealEstate = async ()=>{
    ...
    console.log(data.data.filter(i=> i.id == id))
  ...
  return (
    <div className='sp_real_estate' >
      <Nav width = {width}/>
        ...
        <div className="spl_top_section" style={{backgroundImage: `linear-gradient(rgb(0,0,0,0.3), rgba(0,0,0,0.7)), url(${ listing[0]?.attributes.media.data[0].attributes.url})`}}>
